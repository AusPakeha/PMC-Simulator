...
// GROUND SERVICES
	VO_groundDoctrine  = true;         // true = the mission needs ground stations / false = doesn't need.
		...
		VO_grdServRearm    = false;     // true = rearm stations for ground veh are available / false = not available.
		VO_grdServFull     = false;     // true = chosen assets will bring all available ground services in one place / false = no assets for full service.
...
// AIR SERVICES
	VO_airDoctrine     = true;        // true = the mission needs air stations / false = doesn't need.
		...
		VO_airServRearm    = false;     // true = rearm stations for air veh are available / false = not available.
		VO_airServFull     = false;     // true = chosen assets will bring all available air services in one place / false = no assets for full service.
...
// NAUTIC SERVICES
	VO_nauticDoctrine  = true;        // true = the mission needs nautic stations / false = doesn't need.
		...
		VO_nauServFull     = false;     // true = chosen assets will bring all available nautic services in one place / false = no assets for full service.
...
VO_grdFullAssets = [];
{ VO_grdFullAssets = VO_grdFullAssets + allMissionObjects _x } forEach [
	...
	// "CUP_Type072_Main",
	// "CUP_B_LPD_SAN_ANTONIO_USMC_Empty",
	// "CUP_B_LHD_WASP_USMC_Empty",
	// "CUP_B_LHD_WASP_RUNWAY_USMC_SEA_CONTROL",
	// "CUP_B_LHD_WASP_RUNWAY_USMC"
];

// Define which assets (classnames) are ground repair stations:
VO_grdRepairAssets = [];
{ VO_grdRepairAssets = VO_grdRepairAssets + allMissionObjects _x } forEach [
    "Land_CarService_F",
    "Land_fs_roof_F",
...
VO_grdRefuelAssets = [];
{ VO_grdRefuelAssets = VO_grdRefuelAssets + allMissionObjects _x } forEach [
	"Land_fs_feed_F",
...
VO_grdRearmAssets = [];
{ VO_grdRearmAssets = VO_grdRearmAssets + allMissionObjects _x } forEach [
...
VO_airFullAssets = [];
{ VO_airFullAssets = VO_airFullAssets + allMissionObjects _x } forEach [
	...
	// "CUP_B_LPD_SAN_ANTONIO_USMC_Empty",
	// "CUP_B_LHD_WASP_USMC",
	// "CUP_B_LHD_WASP_USMC_ASSAULT",
	// "CUP_B_LHD_WASP_USMC_Empty",
	// "CUP_B_LHD_WASP_USMC_SEA_CONTROL",
	// "CUP_B_LHD_WASP_RUNWAY_USMC_SEA_CONTROL",
	// "CUP_B_LHD_WASP_RUNWAY_USMC"
];
...
VO_airRepairAssets = [];
{ VO_airRepairAssets = VO_airRepairAssets + allMissionObjects _x } forEach [
	"Sign_Arrow_Direction_F",
    "Sign_Arrow_Direction_Blue_F",
    "Sign_Arrow_Direction_Cyan_F",
    "Sign_Arrow_Direction_Green_F",
...
VO_airRefuelAssets = [];
{ VO_airRefuelAssets = VO_airRefuelAssets + allMissionObjects _x } forEach [
	"Sign_Arrow_Direction_F",
    "Sign_Arrow_Direction_Blue_F",
    "Sign_Arrow_Direction_Cyan_F",
    "Sign_Arrow_Direction_Green_F",
...
VO_airRearmAssets = [];
{ VO_airRearmAssets = VO_airRearmAssets + allMissionObjects _x } forEach [
	"Sign_Arrow_Direction_F",
    "Sign_Arrow_Direction_Blue_F",
    "Sign_Arrow_Direction_Cyan_F",
    "Sign_Arrow_Direction_Green_F",
...
{ VO_airParkingHelperAssets = VO_airParkingHelperAssets + allMissionObjects _x } forEach [
	"Sign_Arrow_Direction_F",
	// "Land_Hangar_F",
	// "Land_Airport_01_hangar_F",
	// "Land_TentHangar_V1_F",
...
VO_nauFullAssets = [];
{ VO_nauFullAssets = VO_nauFullAssets + allMissionObjects _x } forEach [
	// "Land_TBox_F"
];

// Define which assets (classnames) are nautic repair stations:
VO_nauRepairAssets = [];
{ VO_nauRepairAssets = VO_nauRepairAssets + allMissionObjects _x } forEach [
	"Land_RepairDepot_01_civ_F"
    // "Land_TBox_F",
	// "O_T_Truck_03_repair_F",
	// "O_Truck_03_repair_F",
...
VO_nauRefuelAssets = [];
{ VO_nauRefuelAssets = VO_nauRefuelAssets + allMissionObjects _x } forEach [
	"Land_fs_feed_F",
	"Land_FuelStation_Feed_F",
	"Land_FuelStation_03_pump_F",
	"Land_FuelStation_02_pump_F",
...
// Define which assets (classnames) are nautic rearm stations:
	VO_nauRearmAssets = [];
    { VO_nauRearmAssets = VO_nauRearmAssets + allMissionObjects _x } forEach [
		"Land_RepairDepot_01_civ_F"
        // "O_T_Truck_03_ammo_ghex_F",
		// "O_Truck_03_ammo_F",
		// "B_T_Truck_01_ammo_F",
