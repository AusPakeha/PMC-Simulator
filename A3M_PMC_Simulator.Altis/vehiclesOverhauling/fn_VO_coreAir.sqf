...
[] spawn {
	...
	if ( VO_airServFull ) then { _fullAssets = VO_airFullAssets };
	if ( VO_airServRepair ) then { _repAssets = VO_airRepairAssets };
	if ( VO_airServRefuel ) then { _refAssets = VO_airRefuelAssets };
	if ( VO_airServRearm ) then { _reaAssets = VO_airRearmAssets };
