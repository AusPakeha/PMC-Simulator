...
[] spawn {
	...
	if ( VO_grdServFull ) then  { _fullAssets = VO_grdFullAssets };
	if ( VO_grdServRepair ) then { _repAssets = VO_grdRepairAssets };
	if ( VO_grdServRefuel ) then { _refAssets = VO_grdRefuelAssets };
	if ( VO_grdServRearm ) then { _reaAssets = VO_grdRearmAssets };
