...
[] spawn {
	...
	if ( VO_nauServFull ) then { _fullAssets = VO_nauFullAssets };
	if ( VO_nauServRepair ) then { _repAssets = VO_nauRepairAssets };
	if ( VO_nauServRefuel ) then { _refAssets = VO_nauRefuelAssets };
	if ( VO_nauServRearm ) then { _reaAssets = VO_nauRearmAssets };
