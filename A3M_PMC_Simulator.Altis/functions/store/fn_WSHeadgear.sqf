switch (TheSelection) do {
	...
	case 203: { ["H_Beret_Headset_lxWS", "Beret (Headset)", "item"] call A3M_fnc_buyItem; };
	case 204: { ["lxWS_H_Booniehat_desert", "Booniehat (Desert)", "item"] call A3M_fnc_buyItem; };
	case 205: { ["H_Cap_headphones_ion_lxws", "Cap (ION, Headphones)", "item"] call A3M_fnc_buyItem; };
	case 206: { ["lxWS_H_CapB_rvs_blk_ION", "Cap (ION, Headphones, Reversed)", "item"] call A3M_fnc_buyItem; };
	case 207: { ["lxWS_H_Headset", "Military Headset", "item"] call A3M_fnc_buyItem; };
};
