...
window.MISSION_DATA = [
    ...
    },
    {
        ...
        "body": "Salutations,<br><br>N.A.T.O. has lost a fireteam in the Altis area, and U.S. SOCOM requires an immediate asset in the area to rendezvous with the N.A.T.O. team and provide support.<br><br>The location of the stranded teams last known location will be communicated to your map once you accept the contract.",
        "rate": "$1,500,000.00",
        "rp": "900",
        "difficulty": "Medium",
        "logo": "nato"
    ...
    },
    {
        ...
        "body": "Security,<br><br>A special assignment exists in Dorida. Altis ISP SatNet informed the AAF that someone was stealing internet services and committing acts of cyberterrorism.<br><br>AAF has contracted OPSG to raid the hacker den and retrive the logs and stolen data from the hackers server rack.<br><br>The destination will be communicated to your map once you accept the contract.",
        "rate": "$750,000.00",
        "rp": "950",
        "difficulty": "Low / Medium",
        "logo": "astral"
