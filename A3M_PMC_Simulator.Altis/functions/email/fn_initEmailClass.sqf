A3M_EmailClass = createHashMapObject [[
    ...
    ["acceptMission", {
        ...
        switch (_id) do {
            case "contract_M1": { [] spawn A3M_msn_VIPEscort; };
            case "contract_M2": { [] spawn A3M_msn_TRKEscort; };
            case "contract_M3": { remoteExec ["A3M_msn_chkpt", 0, true]; };
            case "contract_M4": { [] spawn A3M_msn_SandE; };
            case "contract_M5": { [] spawn A3M_msn_Raid1; };
            case "contract_M6": { [] spawn A3M_msn_Raid2; };
            case "contract_M7": { [] spawn A3M_msn_reinforce; };
            case "contract_M8": { [] spawn A3M_msn_T9sec; };
            case "contract_M9": { [] spawn A3M_msn_Hden1; };
            case "contract_M10": { [] spawn A3M_msn_DgntrySec; };
            default {};
        };
