class CfgFleet {
    class Store {
        ...
        inventory[] = {
            ...
            // Support
            {"B_Truck_01_fuel_F",1200000},
            {"Box_NATO_Ammo_F",6720},
            {"Box_NATO_Wps_F",91800},

            {"ACE_Wheel",525},
            {"ACE_Track",175},
            {"ACE_Box_Ammo",392378},
            {"ACE_medicalSupplyCrate_advanced",9895},
            {"ACE_Item_Sandbag_empty",1},
            {"ACE_Box_Misc",526593},

            {"rhs_weapon_crate",2106000},
            {"rhsusf_weapon_crate",6900000},
