...
class A3M_GunStore {
    ...
    class Controls {
        ...
        class A3M_btn_pistols: RscButton {
            onButtonClick = "[] call DoAddPistols";
            idc = 1810;
        ...
        class A3M_btn_Rifles: RscButton {
            onButtonClick = "[] call DoAddRifles";
            idc = 1811;
        ...
        class A3M_btn_Lnch: RscButton {
            onButtonClick = "[] call DoAddLaunchers";
            idc = 1812;
        ...
        class A3M_Btn_Optics: RscButton {
            onButtonClick = "[] call DoAddOptics";
            idc = 1814;
        ...
        class A3M_btn_Supp: RscButton {
            onButtonClick = "[] call DoAddSuppressors";
            idc = 1815;
        ...
        class A3M_btn_Expl: RscButton {
            onButtonClick = "[] call DoAddExplosives";
            idc = 1817;
        ...
        class A3M_Btn_Unis: RscButton {
            onButtonClick = "[] call DoAddClothes";
            idc = 1818;
        ...
        class A3M_BackPackButton: RscButton {
            onButtonClick = "[] call DoAddBackpacks";
            idc = 1821;
        ...
        class A3M_HeadGearButton: RscButton {
            onButtonClick = "[] call DoAddHeadgear";
            idc = 1822;
        ...
        class A3M_Btn_Med: RscButton {
            onButtonClick = "[] spawn DoAddMedical";
            idc = 1824;
        ...
        class A3M_Btn_Elect: RscButton {
            onButtonClick = "[] spawn DoAddElect";
            idc = 1825;
        ...
        class A3m_Btn_Buy: RscButton {
            onButtonClick = "[] call A3M_fnc_BuyButton";
            idc = 1826;
