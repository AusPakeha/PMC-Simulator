...
A3M_svr_HackerRaid1 = {
    ...
    newUnitB = newGroupB createUnit ['A3M_Falcon_Smuggler', [19340.1,13236.9,0.00143814], [], 0, 'CAN_COLLIDE'];
    ...
    newUnitD = newGroupD createUnit ['A3M_Falcon_Snatcher', [19343.4,13233,0.0014267], [], 0, 'CAN_COLLIDE'];
