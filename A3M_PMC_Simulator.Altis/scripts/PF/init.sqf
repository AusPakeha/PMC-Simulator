...
switch(true)do{
	case(toLower worldName in["desert", "takistan", "zargabad"]):{
		...
		if (isCUPV) then {
			PFCars=["CUP_C_Datsun_Tubeframe", "CUP_C_Datsun", "CUP_C_Datsun_Plain", "CUP_C_Datsun_Covered", "CUP_C_Datsun_4seat", "CUP_C_Skoda_White_CIV", "CUP_C_Skoda_Blue_CIV", "CUP_C_Skoda_Red_CIV", "CUP_C_Skoda_Green_CIV", "CUP_C_UAZ_Unarmed_TK_CIV", "CUP_C_LR_Transport_CTK", "CUP_C_Ural_Civ_01", "CUP_C_Ural_Open_Civ_01"]
		};
	};
	default{
...

{
	...
	if!(_file isEqualTo"")then{
		...
		["PF_call", "scripts\PF\f\call.sqf"],
		["PF_h1_1", "scripts\PF\A3\h1_1.sqf"],
		["PF_Lh1_1", "scripts\PF\L\h1_1.sqf"],
		["PF_Th1_1", "scripts\PF\T\h1_1.sqf"],
		["PF_Th2_1", "scripts\PF\T\h2_1.sqf"],
		["PF_Lh2_1", "scripts\PF\L\h2_1.sqf"],
		["PF_Lh2_2", "scripts\PF\L\h2_2.sqf"],
		["PF_h2a_1", "scripts\PF\A3\h2a_1.sqf"],
		["PF_h2b_1", "scripts\PF\A3\h2b_1.sqf"],
		["PF_h2c_1", "scripts\PF\A3\h2c_1.sqf"],
		["PF_h3_1", "scripts\PF\A3\h3_1.sqf"],
		["PF_Lh3_1", "scripts\PF\L\h3_1.sqf"],
		["PF_Th3_1", "scripts\PF\T\h3_1.sqf"],
		["PF_Th3s_1", "scripts\PF\T\h3s_1.sqf"],
		["PF_h4_1", "scripts\PF\A3\h4_1.sqf"],
		["PF_Lh4_1", "scripts\PF\L\h4_1.sqf"],
		["PF_h5_1", "scripts\PF\A3\h5_1.sqf"],
		["PF_Lh5_1", "scripts\PF\L\h5_1.sqf"],
		["PF_Th5_1", "scripts\PF\T\h5_1.sqf"],
		["PF_h6_1", "scripts\PF\A3\h6_1.sqf"],
		["PF_Lh6_1", "scripts\PF\L\h6_1.sqf"],
		["PF_Th6_1", "scripts\PF\T\h6_1.sqf"],
		["PF_Th7a_1", "scripts\PF\T\h7_1a.sqf"],
		["PF_Lh7_1", "scripts\PF\L\h7_1.sqf"],
		["PF_h7_1", "scripts\PF\A3\h7_1.sqf"],
		["PF_Lh8_1", "scripts\PF\L\h8_1.sqf"],
		["PF_h8a_1", "scripts\PF\A3\h8a_1.sqf"],
		["PF_h8b_1", "scripts\PF\A3\h8b_1.sqf"],
		["PF_h8c_1", "scripts\PF\A3\h8c_1.sqf"],
		["PF_h9_1", "scripts\PF\A3\h9_1.sqf"],
		["PF_Lh9_1", "scripts\PF\L\h9_1.sqf"],
		["PF_h10_1", "scripts\PF\A3\h10_1.sqf"],
		["PF_Lh10_1", "scripts\PF\L\h10_1.sqf"],
		["PF_Th10_1", "scripts\PF\T\h10_1.sqf"],
		["PF_h11_1", "scripts\PF\A3\h11_1.sqf"],
		["PF_Lh11_1", "scripts\PF\L\h11_1.sqf"],
		["PF_Th11_1", "scripts\PF\T\h11_1.sqf"],
		["PF_h12_1", "scripts\PF\A3\h12_1.sqf"],
		["PF_Lh12_1", "scripts\PF\L\h12_1.sqf"],
		["PF_h13_1", "scripts\PF\A3\h13_1.sqf"],
		["PF_Lh13_1", "scripts\PF\L\h13_1.sqf"],
		["PF_h14_1", "scripts\PF\A3\h14_1.sqf"],
		["PF_Lh14_1", "scripts\PF\L\h14_1.sqf"],
		["PF_h15_1", "scripts\PF\A3\h15_1.sqf"],
		["PF_Lh15_1", "scripts\PF\L\h15_1.sqf"],
		["PF_h16_1", "scripts\PF\A3\h16_1.sqf"],
		["PF_Lh16_1", "scripts\PF\L\h16_1.sqf"],
		["PF_h17_1", "scripts\PF\A3\h17_1.sqf"],
		["PF_Lh17_1", "scripts\PF\L\h17_1.sqf"],
		["PF_h18_1", "scripts\PF\A3\h18_1.sqf"],
		["PF_h19_1", "scripts\PF\A3\h19_1.sqf"],
		["PF_h20_1", "scripts\PF\A3\h20_1.sqf"],
		["PF_h1_2", "scripts\PF\A3\h1_2.sqf"],
		["PF_Lh1_2", "scripts\PF\L\h1_2.sqf"],
		["PF_m1a_2", "scripts\PF\A3\m1a_2.sqf"],
		["PF_m1b_2", "scripts\PF\A3\m1b_2.sqf"],
		["PF_h2a_2", "scripts\PF\A3\h2a_2.sqf"],
		["PF_h2b_2", "scripts\PF\A3\h2b_2.sqf"],
		["PF_h3_2", "scripts\PF\A3\h3_2.sqf"],
		["PF_Lh3_2", "scripts\PF\L\h3_2.sqf"],
		["PF_h4_2", "scripts\PF\A3\h4_2.sqf"],
		["PF_h5_2", "scripts\PF\A3\h5_2.sqf"],
	["PF_h1_4", "scripts\PF\A3\h1_4.sqf"]];
	...
	waitUntil{
		!isNil"PF_BlacklistObj"
	};
	if (count PF_BlacklistObj>0) then {
		PFHomes=PFHomes-[PF_BlacklistObj]
	};
	sleep 1;
	if (PF_On) then {
		private _BLT=(allMissionObjects"EmptyDetector")select{
			"PFBL"in str _x
		};
		if!(_BLT isEqualTo[])then{
			private _BLH=[];
			{
				_tArea=triggerArea _x;
				_size=(if ((_tArea#0)>(_tArea#1)) then {
					_tArea#0
				} else {
					_tArea#1
				});
				_BLH=_BLH+(nearestObjects[_x, PFHomes, _size, true])
			}forEach _BLT;
			if!(_BLH isEqualTo[])then{
				{
					_x setVariable["PF", []]
				}forEach _BLH
			}
		...
		[]spawn compileFinal(loadFile"scripts\PF\f\find.sqf");
		[]spawn compileFinal(loadFile"scripts\PF\f\clean.sqf")
	}
