...
switch(_T)do{
	...
	case"Land_i_Shed_Ind_03_F":{
		_B call PF_h16_1
	};
	case"Land_i_Shed_Ind_old_F":{
		_B call PF_h16_1
	};

	case"Land_Shed_08_brown_F":{
		_B call PF_h9_1
	};
	case"Land_Shed_08_grey_F":{
		_B call PF_h9_1
	};

	case"Land_i_Stone_Shed_01_b_clay_F":{
		_B call PF_h10_1
	};
	case"Land_i_Stone_Shed_01_b_raw_F":{
		_B call PF_h10_1
	};
	case"Land_i_Stone_Shed_01_b_white_F":{
		_B call PF_h10_1
	};
	case"Land_i_Stone_Shed_01_c_clay_F":{
		_B call PF_h10_1
	};
	case"Land_i_Stone_Shed_01_c_raw_F":{
		_B call PF_h10_1
	};
	case"Land_i_Stone_Shed_01_c_white_F":{
		_B call PF_h10_1
	};

	case"Land_Barn_01_brown_F":{
		_B call PF_h11_1
	};
	case"Land_Barn_01_grey_F":{
		_B call PF_h11_1
	};
	...
	default{
		...
		_B setVariable["PF_B", nil];PF_B=PF_B-[_B]
	}
}
