...
A3M_fnc_JRB_RoadBlock = {
    ...
    if (isServer) then {
        ...
        RBtrg setTriggerStatements ["this", "[] remoteExecCall ['A3M_fnc_JRB_Checkpoint'];", ""];
    };
};
...
MP_JRB_Roadblock_Attitude = {
    switch (RAPickedNumber) do {
        ...
        case "M1": {
            ...
            RBVehD addAction ["Arrest for DWI", { ManType = "M4"; publicVariable "ManType"; hint "Abreast? Arrest meee? Fuck YOU! You aren't GAWD!"; sleep 2; hint "Escort the Suspect to Altian jail. Alternately, use the Fast Transport option in the action menu to fast travel the suspect to Altian Jail."; sleep 2; [] call A3M_fnc_jailtrigger; }];
        ...
        case "M3": {
            ...
            RBVehD addAction ["Arrest for Illegal Immigration", { ManType = "M4"; publicVariable "ManType"; hint "Fock you mane. You cops are always trying to keepa de mano down!"; sleep 3.0; hint "Escort the Illegal Alien to Altian Jail. Alternately, use the Fast Transport option in the action menu to fast travel the suspect to Altian Jail."; [] call A3M_fnc_jailtrigger; }];
        ...
        case "M11": {
            ...
            backscatter = RBVeh addAction ["Backscatter Scanner", { hint "Anomaly Detected" }];
            inspect = RBVeh addAction ["Inspect Vehicle", { hint "Visual Inspection: \n The vehicle appears clean and in good repair. \n Smells:\n The vehicle doesn't smell of anything at all.  \n Driver Attitude: \n Driver appears calm and cooperative" }];
            RBVehD addAction ["Sir, You are under arrest...", { ManType = "M4"; publicVariable "ManType"; hint "Oh Mother of God. I've really done it now."; sleep 3.0; hint "Transport the Criminal to Altian Jail. Alternately, use the Fast Transport option in the action menu to fast travel the suspect to Altian Jail."; [] call A3M_fnc_jailtrigger; }];
            goSouth= RBVeh addAction ["Allow to Proceed", { hint "Thank you sir, I'll be moving on now"; [] call DoExitStopSouth; }];
