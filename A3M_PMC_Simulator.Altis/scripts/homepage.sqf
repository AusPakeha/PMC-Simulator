...
this addAction ["Delivery Box", {hint "Your deliveries will arrive in this locker! Access the locker inventory to find odered and delivered goods. \n \n WARNING: \n If you did NOT BUY the item that is in the box, DONT TAKE IT! Someone else bought it, and it belongs to them. Theft is a crime!"}];
this addAction ["Open Private Stash", { cunt= execVM "scripts\locker.sqf" }];
################################## LET US BEGIN #################################### */
