...
//diag_log "//________________ GF_Blood_Pool_BIS_Blood Script _____________";

//systemchat "GF_Blood_Pool_BIS_Blood Script    I n i t i a l i z e d";
...
addMissionEventHandler ["EntityKilled", 
{
	...
	_killed execVM "scripts\GF_Blood_Stains_LITE\GF_Blood_Pool_BIS_Blood\GF_Blood_Pool_BIS_Blood.sqf";
	
	//	systemchat "GF_Set_Blood_Pool_BIS_Blood";	
	};
}];